...
/**
 * This class is a container for all the nested classes that make up the
 * Abstract Syntax Tree (AST). It also acts as a wrapper for the root of the tree.
 */
public class AST implements Visitable {

    // ADD a field to hold the actual root of the tree
    private final Computation root;

    // ADD a constructor that takes the root node built by the parser
    public AST(Computation root) {
        this.root = root;
    }

    // ADD the printPreOrder method, which uses the PrettyPrinter
    public String printPreOrder() {
        if (root == null) {
            return "AST root is null (parsing likely failed).";
        }
        PrettyPrinter printer = new PrettyPrinter();
        return printer.print(this.root);
    }
    
    // ADD a getter for the TypeChecker to use
    public Computation getRoot() {
        return this.root;
    }

    // ADD the accept method, which passes the visit call down to the root
    @Override
    ...
    // ALL NESTED NODE CLASSES ARE DEFINED BELOW
    // //////////////////////////////////////////////////////////////////
    ...
    public static class Assignment extends Node implements Statement {
        private Expression destination, source;
    ...
    public static class IfStatement extends Node implements Statement {
        ...
        private StatementSequence elseBlock; // Can be null
    ...
    public static class ReturnStatement extends Node implements Statement {
        private Expression value; // Can be null
    ...
    public static class ArgumentList extends Node {
        ...
        public ArgumentList(int l, int c) { super(l, c); this.arguments = new ArrayList<>(); }
    ...
    public static class DeclarationList extends Node implements List<Declaration> {
        ...
        @Override public void accept(NodeVisitor v) { v.visit(this); }
        @Override public int size() { return list.size(); } @Override public boolean isEmpty() { return list.isEmpty(); } @Override public boolean contains(Object o) { return list.contains(o); } @Override public java.util.Iterator<Declaration> iterator() { return list.iterator(); } @Override public Object[] toArray() { return list.toArray(); } @Override public <T> T[] toArray(T[] a) { return list.toArray(a); } @Override public boolean add(Declaration e) { return list.add(e); } @Override public boolean remove(Object o) { return list.remove(o); } @Override public boolean containsAll(java.util.Collection<?> c) { return list.containsAll(c); } @Override public boolean addAll(java.util.Collection<? extends Declaration> c) { return list.addAll(c); } @Override public boolean addAll(int i, java.util.Collection<? extends Declaration> c) { return list.addAll(i, c); } @Override public boolean removeAll(java.util.Collection<?> c) { return list.removeAll(c); } @Override public boolean retainAll(java.util.Collection<?> c) { return list.retainAll(c); } @Override public void clear() { list.clear(); } @Override public Declaration get(int i) { return list.get(i); } @Override public Declaration set(int i, Declaration e) { return list.set(i, e); } @Override public void add(int i, Declaration e) { list.add(i, e); } @Override public Declaration remove(int i) { return list.remove(i); } @Override public int indexOf(Object o) { return list.indexOf(o); } @Override public int lastIndexOf(Object o) { return list.lastIndexOf(o); } @Override public java.util.ListIterator<Declaration> listIterator() { return list.listIterator(); } @Override public java.util.ListIterator<Declaration> listIterator(int i) { return list.listIterator(i); } @Override public List<Declaration> subList(int f, int t) { return list.subList(f, t); }
    }
    ...
    public static class StatementSequence extends Node implements List<Statement> {
        ...
        @Override public void accept(NodeVisitor v) { v.visit(this); }
        @Override public int size() { return list.size(); } @Override public boolean isEmpty() { return list.isEmpty(); } @Override public boolean contains(Object o) { return list.contains(o); } @Override public java.util.Iterator<Statement> iterator() { return list.iterator(); } @Override public Object[] toArray() { return list.toArray(); } @Override public <T> T[] toArray(T[] a) { return list.toArray(a); } @Override public boolean add(Statement e) { return list.add(e); } @Override public boolean remove(Object o) { return list.remove(o); } @Override public boolean containsAll(java.util.Collection<?> c) { return list.containsAll(c); } @Override public boolean addAll(java.util.Collection<? extends Statement> c) { return list.addAll(c); } @Override public boolean addAll(int i, java.util.Collection<? extends Statement> c) { return list.addAll(i, c); } @Override public boolean removeAll(java.util.Collection<?> c) { return list.removeAll(c); } @Override public boolean retainAll(java.util.Collection<?> c) { return list.retainAll(c); } @Override public void clear() { list.clear(); } @Override public Statement get(int i) { return list.get(i); } @Override public Statement set(int i, Statement e) { return list.set(i, e); } @Override public void add(int i, Statement e) { list.add(i, e); } @Override public Statement remove(int i) { return list.remove(i); } @Override public int indexOf(Object o) { return list.indexOf(o); } @Override public int lastIndexOf(Object o) { return list.lastIndexOf(o); } @Override public java.util.ListIterator<Statement> listIterator() { return list.listIterator(); } @Override public java.util.ListIterator<Statement> listIterator(int i) { return list.listIterator(i); } @Override public List<Statement> subList(int f, int t) { return list.subList(f, t); }
    }
